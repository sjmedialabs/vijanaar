      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center">
            <Image src={companyData?.sectionOne?.headerLogoUrl || "/vijanaar-logo.png"} alt="Vijanaar" width={120} height={40} className="h-8 w-auto" />
          </Link>
          ...
          <div className="flex items-center space-x-4 mr-[20px] xl:mr-0">
            ...
            >
              ...
              <span className="font-medium">{companyData?.sectionOne?.phone1 || "+91 99634-90606"}</span>
            </a>
